...
void game::SUB_000AC9() {
    ...
    L_000B02:
        ...
        a = myMapper->readCPU(0x0053);
        setLoadFlag(a);
        opCMP(a, myMapper->readCPU(0x0400 + x));
        if (!flgZ) {
            opCMP(a, 0x01);
            if (!flgZ) {
...
void game::SUB_000F42() {
    ...
    if (!flgZ) {
        ...
        a = myMapper->readCPU(0x0015);
        setLoadFlag(a);
        opCMP(a, myMapper->readCPU(0x0514));
        if (flgZ) {
            goto L_000F92;
        }
        myMapper->writeCPU(0x0514, a);
...
void game::SUB_00104C() {
    ...
    if (flgZ) {
        ...
        if (!flgZ) {
            ...
            setLoadFlag(a);
            opCMP(a, myMapper->readCPU(0x0059));
            if (flgZ) {
                goto L_001074;
            }
            popAddress();
...
void game::SUB_001547() {
    ...
    L_0015B3:
        ...
        if (!flgZ) {
            ...
            flgC = true;
            opSBC(0x10);
            opCMP(a, myMapper->readCPU(0x0095));
            if (flgC) {
                a = 0xFF;
                setLoadFlag(a);
...
void game::SUB_001800() {
    ...
    if (flgZ) {
        ...
        L_001827:
            ...
            setLoadFlag(a);
            opCMP(a, myMapper->readCPU(0xC1A8 + x));
            if (!flgZ) {
                opINX(1);
                opCMP(a, myMapper->readCPU(0xC1A8 + x));
                if (!flgZ) {
...
void game::SUB_00191A() {
    ...
    setLoadFlag(a);
    while (true) {
        opCMP(x, myMapper->readCPU(0x0059));
        if (flgZ) {
            goto L_00193B;
        }
        flgC = false;
...
L_00193B:
    ...
    while (true) {
        ...
        do {
            ...
            setLoadFlag(a);
            opCMP(a, myMapper->readCPU(0x0086));
        } while (!flgZ);
        opINX(1);
        a = myMapper->readCPU(0xC08C + x);
        setLoadFlag(a);
        ...
        if (flgZ) {
            ...
            if (!flgC) {
                ...
                if (flgZ) {
                    ...
                    a = myMapper->readCPU(0x0200 + x);
                    setLoadFlag(a);
                    opCMP(a, myMapper->readCPU(0x0200));
                    if (!flgC) {
                        flgC = false;
                        opADC(0x0F);
                        opCMP(a, myMapper->readCPU(0x0200));
...
void game::SUB_001C30() {
    ...
    if (!flgZ) {
        ...
        x = myMapper->readCPU(0x005D);
        setLoadFlag(x);
        opCMP(a, myMapper->readCPU((0x00A3 + x) & 0x00ff));
        if (!flgZ) {
            goto L_001C68;
        }
        x = myMapper->readCPU(0x005D);
...
void game::SUB_001CD0() {
    ...
    if (flgZ) {
        ...
        setLoadFlag(x);
        while (true) {
            opCMP(a, myMapper->readCPU(0xC3FC + x));
            if (flgZ) {
                goto L_001D13;
            }
            opINX(1);
    ...
    setLoadFlag(x);
    while (true) {
        opCMP(a, myMapper->readCPU(0xC412 + x));
        if (flgZ) {
            goto L_001D13;
        }
        opINX(1);
...
void game::SUB_001E86() {
    ...
    setLoadFlag(a);
    do {
        opCMP(a, myMapper->readCPU(0xC41D + y));
        if (flgC) {
            opCMP(a, myMapper->readCPU(0xC420 + y));
            if (flgC) {
                goto L_001E9F;
            }
            opINC(0x0001, 1);
...
void game::SUB_001EA5() {
    ...
    flgC = true;
    opSBC(0x01);
    opCMP(a, myMapper->readCPU(0x0000));
    if (flgZ) {
        goto L_001EE8;
    }
    flgC = true;
...
void game::SUB_00205A() {
    ...
    if (!flgZ) {
        ...
        while (true) {
            ...
            setLoadFlag(a);
            opCMP(a, myMapper->readCPU(0x000C));
            if (flgZ) {
                goto L_00208A;
            }
            opINX(1);
...
void game::SUB_0020F1() {
    ...
    setLoadFlag(y);
    opCMP(a, myMapper->readCPU(0xC177 + x));
    if (!flgZ) {
...
void game::SUB_002112() {
    ...
    while (true) {
        ...
        opCMP(a, myMapper->readCPU(0x000B));
        if (flgZ) {
            goto L_002124;
        }
        opINY(1);
...
void game::SUB_0021E5() {
    ...
    L_002228:
        ...
        setLoadFlag(a);
        opCMP(a, myMapper->readCPU(0xC1F6 + x));
        if (flgZ) {
            goto L_002237;
        }
    }
...
L_00239B:
    ...
    setLoadFlag(x);
    opCMP(a, myMapper->readCPU(0xC3E2 + x));
    if (!flgZ) {
        opCMP(a, myMapper->readCPU(0xC3E4 + x));
        if (!flgZ) {
            goto L_0023AF;
        }
    }
...
L_00244B:
    ...
    if (!flgZ) {
        ...
        x = myMapper->readCPU(0x00AE);
        setLoadFlag(x);
        opCMP(a, myMapper->readCPU((0x00DB + x) & 0x00ff));
        if (!flgZ) {
            goto L_00250C;
        L_00249B:
            opINC(0x0001, 1);
...
L_002702:
    ...
    if (flgZ) {
        a = myMapper->readCPU(0x0000);
        setLoadFlag(a);
        opCMP(a, myMapper->readCPU(0xC3EA + y));
        if (flgZ) {
            goto L_002735;
        }
        ...
        a = myMapper->readCPU(0x0000);
        setLoadFlag(a);
        opCMP(a, myMapper->readCPU(0xC3EE + y));
        if (flgZ) {
            goto L_002735;
        }
...
void game::SUB_0027A3() {
    ...
    setLoadFlag(y);
    while (true) {
        opCMP(y, myMapper->readCPU(0x000A));
        if (flgZ) {
            goto L_0027F2;
        }
        a = myMapper->readCPU(myMapper->readCPU(0x0007) + (myMapper->readCPU((0x0007 + 1) & 0x00ff) << 8) + y);
...
void game::SUB_002C44() {
    ...
    L_002C97:
        ...
        a = myMapper->readCPU(0x005D);
        setLoadFlag(a);
        opCMP(a, myMapper->readCPU(0xC1FD + x));
        if (flgZ) {
            goto L_002CAF;
        }
    }
...
void game::SUB_002FF5() {
    ...
    if (flgZ) {
        ...
        if (flgC) {
            ...
            setLoadFlag(a);
            opCMP(a, myMapper->readCPU(0x0047));
            if (flgC) {
                a = myMapper->readCPU(0x004C);
                setLoadFlag(a);
                opCMP(a, myMapper->readCPU(0x0046));
                if (flgC) {
                    a = myMapper->readCPU(0x0048);
                    setLoadFlag(a);
                    opCMP(a, myMapper->readCPU(0x004A));
                    if (!flgC) {
                        goto L_003057;
                    }
                    a = 0x01;
